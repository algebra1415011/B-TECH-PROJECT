clear;
load 'C:\Users\algebra\Desktop\codesandthesis\mfcc_output\combinedmatrixforv1\folder4\joinedtarget4.mat';
...
clear s row column;
training(1:2374,:)=dataset3(1:2374,:);
...
net=newff(P,T,1000);%two hidden layers, 24 nodes in first hidden layer and 8 nodes in second hidden layer
net.performFcn = 'mse';
